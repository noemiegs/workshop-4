...
export async function generateRsaKeyPair(): Promise<GenerateRsaKeyPair> {
  const keyPair = await webcrypto.subtle.generateKey(
    {
      name: "RSA-OAEP",
      modulusLength: 2048, // La longueur du module RSA
      publicExponent: new Uint8Array([1, 0, 1]), // 65537, exponent commun
      hash: "SHA-256", // Le hash utilisé
    },
    true, // Clés extractables
    ["encrypt", "decrypt"] // Utilisations possibles des clés
  );
